...
//get information stored in the userprofile database
...
<!-- HTML to display the user you clicked on's profile, Follow and Message don't currently do anything (more proof of concept) but can be expanded to work-->
<div class="container">
	    <div class="main-body">
